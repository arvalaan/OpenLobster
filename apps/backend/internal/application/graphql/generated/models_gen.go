...
type ChannelSecretsConfig struct {
	...
	MattermostEnabled   *bool   `json:"mattermostEnabled,omitempty"`
	MattermostServerURL *string `json:"mattermostServerURL,omitempty"`
	MattermostBotToken  *string `json:"mattermostBotToken,omitempty"`
}
...
type UpdateConfigInput struct {
	...
	ChannelMattermostEnabled   *bool              `json:"channelMattermostEnabled,omitempty"`
	ChannelMattermostServerURL *string            `json:"channelMattermostServerURL,omitempty"`
	ChannelMattermostBotToken  *string            `json:"channelMattermostBotToken,omitempty"`
	WizardCompleted            *bool              `json:"wizardCompleted,omitempty"`
}
